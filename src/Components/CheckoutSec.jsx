...
const InputItem = ({ input }) => {
	return (
		<div className="flex flex-col gap-2 mt-6">
			...
			<input
				type={input.type}
				className="h-14 p-4  bg-opacity-5  focus:outline-none focus:border  rounded-md"
				id={input.for}
...
const CheckoutSec = () => {
	return (
		<section className="py-14 md:py-24  text-zinc-900  relative overflow-hidden z-10">
