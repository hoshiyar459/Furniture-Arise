...
const Testimonial = () => {
	...
	return (
		<section className="ezy__testimonial21 light py-14 md:py-24    ">
			<div className="container px-4 mx-auto relative">
				<div className="flex justify-center text-center mb-6 lg:mb-12">
					<div className="max-w-lg">
						<h2 className="text-3xl leading-none md:text-[45px] font-bold mb-6 text-green-500">
				...
				<div className="relative flex justify-center items-center my-12">
					<button
						className="text-lg bg-white shadow-2xl dark:bg-green-600 dark:text-white opacity-75 hover:opacity-100 w-12 h-12 flex justify-center items-center rounded-full mr-4"
						onClick={() => handleControl("prev")}
					>
						<FontAwesomeIcon icon={faAngleLeft} />
					</button>
					<button
						className="text-lg bg-white shadow-2xl dark:bg-green-600 dark:text-white opacity-75 hover:opacity-100 w-12 h-12 flex justify-center items-center rounded-full"
